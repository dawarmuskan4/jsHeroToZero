...
const checkIn = function (flightNum, passenger) {
  ;(flightNum = 'LH999'), (passenger.name = 'Ms. ' + passenger.name)

  if (passenger.passport === 2346429825) {
    alert('Check IN')
  } else {
...
//     }
// }
// const greeter= greet1('hello')
// greeter('Sonya')
// greet1("Hey")("Naina")

// //another way wth arrow function
...
// //alternative of apply method using call method
...
// //alternative way to write above function using technique function returning function
...
and the 'string' option. Do NOT put the arrays in the poll object! So what shoud the this keyword look 
...
// poll.displayResult.call({answers: [1,3,4,5,1,1]})
